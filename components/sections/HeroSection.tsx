        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-block bg-accent/10 px-4 py-2 rounded-full">
              <p className="text-sm font-medium text-accent">40 años de experiencia certificada</p>
            </div>
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Soy Maritza Cañas, asesora integral de seguros certificada. Te ayudaré a encontrar la póliza perfecta
              para asegurar el futuro de quienes amas.
            </p>
          ...
          <div className="relative sm:h-80 md:h-96 block">
            <img
              ...
              alt="Familia sonriendo protegida por un seguro"
