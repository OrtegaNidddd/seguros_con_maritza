        ...
        <div className="grid md:grid-cols-[1.4fr_1fr] gap-12 items-stretch">
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="space-y-4">
              <h2 className="text-3xl md:text-5xl font-bold text-foreground">Sobre mí</h2>

              <p className="text-xl text-muted-foreground leading-relaxed">
                Soy <span className="font-semibold text-primary">Maritza Cañas</span>, asesora de seguros en Cúcuta con{" "}
            ...
            <div className="space-y-3 mt-8">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Como asesora independiente en Norte de Santander, he ayudado a cientos de familias a proteger su futuro
                con pólizas de vida y salud en Cúcuta, coberturas para autos y hogar, y pólizas educativas para los más
                pequeños. Además, soy creadora y promotora del programa de salud mental{" "}
                <span className="font-semibold">SAMI SALUD</span>, demostrando mi compromiso con el bienestar integral.
              </p>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Ofrezco asesoría personalizada en seguros para familias y empresas en Cúcuta, Norte de Santander, y
                acompaño con asesoría financiera básica para que tomes decisiones claras sobre tus pólizas.
              </p>
            </div>
          </div>
