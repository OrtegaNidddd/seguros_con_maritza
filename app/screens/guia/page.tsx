      ...
      <div className="mx-auto max-w-6xl px-4 pb-20 pt-16 sm:px-6 lg:px-8">
        ...
        <header className="mt-8 space-y-4 text-center md:text-left">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            Una guía pensada para personas que no son expertas en finanzas, pero quieren tomar decisiones
            inteligentes al proteger su salud, su familia y su patrimonio.
          </p>
        </header>
