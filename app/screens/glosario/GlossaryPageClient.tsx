...
const glossaryCategories: GlossaryCategory[] = [
  ...
  },
  {
    ...
    terms: [
      ...
      { term: "Red de prestadores", definition: "Red de clínicas y médicos a nivel nacional." },
      { term: "Hospitalización", definition: "Cobertura ilimitada de los gastos generados durante una estadía en clínicas en el país." },
      ...
      { term: "Enfermedades congénitas", definition: "Alteraciones o condiciones médicas presentes desde el nacimiento, que pueden estar incluidas dentro de la cobertura de la póliza dependiendo del plan." },
      { term: "Trasplante de órganos", definition: "Gastos del donante y del receptor cubiertos por la póliza." },
    ],
  },
  {
    id: "vida",
    ...
    terms: [
      ...
      { term: "Designación irrevocable", definition: "Nombramiento de beneficiarios que requiere su autorización para modificarse." },
      { term: "Anticipo de beneficios", definition: "Porción del dinero que puedes solicitar en vida ante eventos específicos." },
      { term: "Tabla de mortalidad", definition: "Estadística utilizada por las aseguradoras para calcular riesgos y costos." },
      { term: "Seguro colectivo de vida", definition: "Cobertura que las empresas ofrecen a sus colaboradores como beneficio laboral." },
    ],
  },
  {
    id: "autos",
      ...
      <div className="mx-auto max-w-6xl px-4 pb-20 pt-16 sm:px-6 lg:px-8">
        ...
        <header className="mt-8 space-y-4 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground">
            Glosario de seguros en Cúcuta para entender tus pólizas
          </h1>
          <p className="text-lg text-muted-foreground max-w-3xl">
            Explora los términos esenciales de pólizas de vida y salud en Cúcuta, autos, hogar y pólizas educativas.
            Usa el buscador para aprender rápido cómo protegen a tu familia y tus finanzas personales en Cúcuta y Norte
            de Santander con la asesora de seguros Maritza Cañas.
          </p>
        </header>
                  ...
                  <div className="rounded-[28px] bg-white/85 p-8 dark:bg-slate-950/85">
                    <div className="mb-8 flex flex-wrap items-center gap-4">
                      ...
                      <div className="min-w-[250px] flex-1">
                        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-muted-foreground">Categoría</p>
